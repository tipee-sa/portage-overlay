...
src_install() {
	...
	dosym ${D}/usr/lib/google-cloud-sdk/bin/gcloud /usr/bin/gcloud
	dosym ${D}/usr/lib/google-cloud-sdk/bin/docker-credential-gcloud /usr/bin/docker-credential-gcloud
	...
	dosym ${D}/usr/lib/google-cloud-sdk/bin/gsutil /usr/bin/gsutil
